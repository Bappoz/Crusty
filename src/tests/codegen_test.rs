...
fn test_happy_path_no_spill() {
    ...
    let intervals = vec![
        LiveInterval {temp: 0, start: 1, end: 4},
        LiveInterval {temp: 1, start: 2, end: 3},
    ];
...
fn test_register_recycling() {
    ...
    let intervals = vec![
        LiveInterval {temp: 0, start: 1, end: 2},
        LiveInterval {temp: 1, start: 3, end: 5},
    ];
...
fn test_linear_scan_spill() {
    ...
    let intervals = vec![
        LiveInterval {temp: 0, start: 1, end: 10},
        LiveInterval {temp: 1, start: 2, end: 5},
        LiveInterval {temp: 2, start: 3, end: 6},
        LiveInterval {temp: 3, start: 4, end: 7},
        LiveInterval {temp: 4, start: 5, end: 6},
    ];
